...
parser.add_argument('-d', '--display-all', help='display all steps', action='store_true')
parser.add_argument('--display-preview', help='display a preview of the crossroad schematization', action='store_true')
...
if args.input_model:
    ...
    G_init = ox.graph_from_point((latitude, longitude), dist=200, network_type="all", retain_all=False, truncate_by_edge=True, simplify=False)
    ...
    G = cseg.Segmentation.remove_footways_and_parkings(deepcopy(G_init), False)
