...
class CrossroadSchematization:
    ...
    def toGeojson(self, filename):
        ...
        df = df.append(TurningSidewalk.toGDFSidewalks(self.merged_sidewalks))
        df = df.append(Branch.toGDFBranches(self.branches))
        df = df.append(TrafficIsland.toGDFTrafficIslands(self.traffic_islands))
        df = df.append(Crossing.toGDFCrossings(self.crossings))
